...
public class Input {
    ...
    public void gerarTabuleiro() {
        /*System.out.println("Selecione a altura do tabuleiro: ");
        int x = scan.nextInt();
        scan.nextLine();

        System.out.println("Selecione a largura do tabuleiro: ");
        int y = scan.nextInt();
        scan.nextLine();*/
    ...
    public Navio criarNavio(int jogador) {
        ...
        Quadrado parteNavio;
        Navio navio;
        System.out.println("Jogador " + GameJogador + " posicione o navio.");
    ...
    public int[] atirar(int jogador) {
        int GameJogador = jogador + 1;
        System.out.println("Jogador " + GameJogador + " atire.");
        System.out.println("Selecione a linha: ");
        int row = scan.nextInt();
